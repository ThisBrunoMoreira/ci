...
describe('Searchable Repository unit tests', () => {
  ...
  describe('SearchResult', () => {
    it('should initialize with default values and match expected JSON', () => {
      ...
      expect(sut.toJSON()).toEqual(expectedJSON);
    });

    it('should initialize with provided values and match expected JSON', () => {
      const sut = new SearchResult({
        items: ['test1', 'test2', 'test3', 'test4'] as any,
        total: 4,
        currentPage: 1,
    ...
    it('should calculate the correct last page when perPage is smaller than total', () => {
      const sut = new SearchResult({
        items: ['test1', 'test2', 'test3', 'test4'] as any,
        total: 4,
        currentPage: 1,
    ...
    it('should calculate the correct last page when perPage is larger than total', () => {
      const sut = new SearchResult({
        items: ['test1', 'test2', 'test3', 'test4'] as any,
        total: 54,
        currentPage: 1,
